...
sealed class Screen(val route: String) {
    ...
    object Dompetku : Screen("dompetku")
    ...
    object EditTransaksi : Screen("edit_transaksi/{transactionId}") {
        fun createRoute(transactionId: String) = "edit_transaksi/$transactionId"
    }
}